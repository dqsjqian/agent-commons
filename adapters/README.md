...
We **do not** ship per-agent code adapters — adapters are documentation only. The protocol is designed so any sufficiently capable agent can self-onboard from `~/.agent-commons/ONBOARDING.md`, then use `skills/SKILL.md` as its runtime capability.
